...
import com.nsw.a6vfilm.utils.BitmapUtils;
...
public abstract class BlurDialog extends Dialog {
    ...
    public BlurDialog(Activity activity) {
        super(activity, R.style.DialogBlurStyle);
    ...
    private class BlurAsyncTask extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            BitmapUtils.saveBitmapToFile("my.jpg",bitmap);
        }
        ...
        protected void onPostExecute(Object o) {
            ...
            if (bitmap != null) {
                blurImage.setBackgroundDrawable(new BitmapDrawable(bitmap));
                blurImage.invalidate();
                BitmapUtils.saveBitmapToFile("1.jpg",bitmap);
            }
        }
    }
